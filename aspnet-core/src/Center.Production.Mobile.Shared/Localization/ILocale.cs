...
namespace Center.Production.Localization
{
    ...
    /// Center-specific locales to a value supported in .NET because
    ...
    {
        ///	<summary>
        /// This method must evaluate Center-specific locale settings
        /// and convert them (when necessary) to a valid .NET locale.
        /// </summary>
        CultureInfo GetCurrentCultureInfo();

        /// <summary>
        /// CurrentCulture and CurrentUICulture must be set in the Center project, 
