...
using MvvmHelpers;
using Center.Production.Authorization.Users.Profile;
using Center.Production.Authorization.Users.Profile.Dto;
using Center.Production.Commands;
using Center.Production.Core.Threading;
using Center.Production.Models.NavigationMenu;
using Center.Production.Services.Navigation;
...
using Center.Production.Controls;
using Center.Production.Dto;
using Center.Production.Extensions;
using Center.Production.Localization;
using Center.Production.UI;
using Center.Production.UI.Assets;
using Center.Production.Views;
using DependencyResolver = Center.Production.Core.Dependency.DependencyResolver;
...
namespace Center.Production.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Production";
        ...
        private async Task CropImageIfNeedsAsync(MediaFile photo)
        {
            ...
            if (Device.RuntimeCenter == Device.Android)
            {
