...
using Center.Production.Web.Authentication.JwtBearer;
using Center.Production.Web.Authentication.TwoFactor;
using Center.Production.Web.Chat.SignalR;
using Center.Production.Web.Configuration;

namespace Center.Production.Web
{
    [DependsOn(
    ...
    public class ProductionWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ProductionWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(ProductionApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ProductionWebCoreModule).GetAssembly());
        }
        ...
        private void SetAppFolders()
        {
            ...
            {
                var currentAssemblyDirectoryPath = typeof(ProductionWebCoreModule).GetAssembly().GetDirectoryPathOrNull();
