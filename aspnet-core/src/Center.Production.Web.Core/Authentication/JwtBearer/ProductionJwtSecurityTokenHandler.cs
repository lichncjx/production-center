...
namespace Center.Production.Web.Authentication.JwtBearer
{
    public class ProductionJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public ProductionJwtSecurityTokenHandler()
        {
