...
{
    public class SessionAppService : ProductionAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = ProductionConsts.Currency,
                    CurrencySign = ProductionConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = ProductionConsts.AllowTenantsToChangeEmailSettings
                }
            };
