...
using Center.Production.Auditing.Exporting;
...
using EntityHistoryHelper = Center.Production.EntityHistory.EntityHistoryHelper;

namespace Center.Production.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : ProductionAppServiceBase, IAuditLogAppService
    {
