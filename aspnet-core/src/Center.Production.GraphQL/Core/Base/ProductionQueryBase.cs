...
namespace Center.Production.Core.Base
{
    public abstract class ProductionQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected ProductionQueryBase(string fieldName,
