...
using Center.Production.Core.Base;
using Center.Production.Core.Extensions;
using Center.Production.Dto;
using Center.Production.Types;

namespace Center.Production.Queries
{
    public class OrganizationUnitQuery : ProductionQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
