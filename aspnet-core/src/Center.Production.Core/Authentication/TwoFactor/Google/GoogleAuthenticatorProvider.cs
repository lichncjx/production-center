...
namespace Center.Production.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : ProductionServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Center.Production", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
