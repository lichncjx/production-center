...
using Center.Production.MultiTenancy.Demo;
...
namespace Center.Production.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(ProductionConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
