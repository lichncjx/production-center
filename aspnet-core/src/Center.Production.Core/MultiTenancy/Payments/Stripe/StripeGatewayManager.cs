...
namespace Center.Production.MultiTenancy.Payments.Stripe
{
    ...
    public class StripeGatewayManager : ProductionServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Production";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + ProductionConsts.Currency;
        }
