...
using Center.Production.Web.Public.Startup;
using Center.Production.Web.Session;

namespace Center.Production.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : ProductionViewComponent
    {
