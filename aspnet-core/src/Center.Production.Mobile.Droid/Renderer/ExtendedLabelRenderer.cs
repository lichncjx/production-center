...
//       Center set of controls tailored to work with Xamarin Forms.
// </summary>
// ***********************************************************************
//
...
using Center.Production.Renderer;
using Xamarin.Forms;
using Xamarin.Forms.Center.Android;

[assembly: ExportRenderer(typeof(ExtendedLabel), typeof(ExtendedLabelRenderer))]
namespace Center.Production.Renderer
{
	/// <summary>
