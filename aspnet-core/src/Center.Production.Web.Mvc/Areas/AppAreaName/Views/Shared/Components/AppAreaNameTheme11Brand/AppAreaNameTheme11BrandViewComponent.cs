...
namespace Center.Production.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameTheme11Brand
{
    public class AppAreaNameTheme11BrandViewComponent : ProductionViewComponent
    {
