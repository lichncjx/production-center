...
namespace Center.Production.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameTheme6Brand
{
    public class AppAreaNameTheme6BrandViewComponent : ProductionViewComponent
    {
