...
namespace Center.Production.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameDefaultBrand
{
    public class AppAreaNameDefaultBrandViewComponent : ProductionViewComponent
    {
