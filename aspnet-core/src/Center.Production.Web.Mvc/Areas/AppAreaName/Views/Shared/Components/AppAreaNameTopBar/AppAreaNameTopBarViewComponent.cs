...
namespace Center.Production.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameTopBar
{
    public class AppAreaNameTopBarViewComponent : ProductionViewComponent
    {
