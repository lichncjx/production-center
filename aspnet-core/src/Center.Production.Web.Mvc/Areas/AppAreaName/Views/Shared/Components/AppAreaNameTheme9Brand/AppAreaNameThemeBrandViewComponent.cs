...
namespace Center.Production.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameTheme9Brand
{
    public class AppAreaNameTheme9BrandViewComponent : ProductionViewComponent
    {
