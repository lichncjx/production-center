...
using Center.Production.Web.Common;
using Center.Production.Web.Resources;
using PaulMiami.AspNetCore.Mvc.Recaptcha;
using Swashbuckle.AspNetCore.Swagger;
using Center.Production.Web.IdentityServer;
using Center.Production.Web.Swagger;
using Stripe;
...
namespace Center.Production.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            //{
            //    options.SwaggerDoc("v1", new Info { Title = "Production API", Version = "v1" });
            ...
            return services.AddAbp<ProductionWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            //{
            //    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "Production API V1");
