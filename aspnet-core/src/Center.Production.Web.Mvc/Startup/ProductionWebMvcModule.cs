...
namespace Center.Production.Web.Startup
{
    ...
    public class ProductionWebMvcModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public ProductionWebMvcModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ProductionWebMvcModule).GetAssembly());
        }
